...
public:
    ...
    void addItemToOrderCSV(const string& orderFile, const map<string, double>& menu) {
        string menuItem;
        double price = 0.0;
    ...
    void modifyOrderM() {
        cout << "Enter pin for confimation:\n";
        int userPin;
        cin >> userPin;
        displayOrder(userPin);
